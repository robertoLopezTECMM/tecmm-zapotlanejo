  ...
  render(){
    ...
    return(
      <div className="div-principalMenuCentral">
        ...
        <a href="/">
          <img className="img-menuCentral-header" src="http://zapotlanejo.tecmm.edu.mx/imagenes/header.jpg"/>
        </a>
        <img className="img-menuCentral-nombre" src="http://zapotlanejo.tecmm.edu.mx/imagenes/zapotlanejo.png"/>
